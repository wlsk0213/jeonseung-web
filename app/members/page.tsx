...
export const metadata: Metadata = {
  title: '구성원',
  description:
    '노무법인 전승의 구성원을 소개합니다. 팀별 전문성으로 경험이 증명하는 노무법인 — 천안 본사·서울지사·경기지사의 공인노무사와 전문 인력이 분야별 전문센터에서 산업안전·중대재해, 산재보상, 직장 내 괴롭힘 조사, 인사노무 자문을 맡습니다.',
};
...
const personJsonLd = {
  ...
  jobTitle: '대표 공인노무사',
  description:
    '전지나 노무사는 충남 천안에서 산업안전·중대재해, 산재보상, 직장 내 괴롭힘 분야를 중심으로 활동하는 공인노무사로, 노무법인 전승의 대표이며 충청남도 갑질·괴롭힘 예방 안심노무사다. 노무법인 전승은 천안 본사와 서울·경기 지사에서 전국 사업장에 대응한다.',
    ...
    <main>
      ...
      <div className="phero">
        <div className="wrap">
          ...
          <h1>구성원</h1>
          <p className="sub">
            팀별 전문성으로 경험이 증명하는 노무법인 — 분야별 전문센터의 전문 노무사가 함께 일합니다.
            노무법인 전승은 천안 본사와 서울·경기 지사에서 전국 사업장에 대응합니다.
          </p>
        </div>
      </div>
